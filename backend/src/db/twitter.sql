...
-- Παρ 07 Απρ 2023 07:56:52 μμ CEST
...
CREATE TABLE IF NOT EXISTS `twitter`.`user` (
  ...
  `avatar` VARCHAR(100) NULL DEFAULT 'shorturl.at/qzAF8',
...
CREATE TABLE IF NOT EXISTS `twitter`.`user_reacts_to_tweet` (
  ...
  INDEX `reaction_UNIQUE` (`userID` ASC, `tweetID` ASC, `isLike` ASC, `isRetweet` ASC),
